...
export default function CreateTreeScreen() {
  const router = useRouter();
  const { farmId, position } = useLocalSearchParams();
    ...
    >
      <ScrollView style={styles.scrollView} keyboardShouldPersistTaps="handled">
        ...
        <View style={styles.header}>
          ...
          <Text style={styles.headerTitle}>Nouvel Arbre - {position}</Text>
          <View style={{ width: 24 }} />
        </View>
        ...
        <View style={styles.content}>
          ...
          >
            {loading ? (
              ...
              <Text style={styles.submitButtonText}>Enregistrer l'arbre</Text>
            )}
          </TouchableOpacity>
        </View>
      </ScrollView>
